...
// Base route
export const baseRoot = (req, res) => {
  res.status(200).send(
    `<h1>✅ Welcome to MERN-Todofy!</h1>
     <p>See Live Web URL for this Server - 
     <a href="https://mern-todofy.netlify.app">https://mern-todofy.netlify.app</a></p>`
  );
};
